...
* [Удаление сегмента](#delete-segmentdelete-segment)
* [Получение сегментов пользователя](#get-segments)
* [Редактирование сегментов пользователя](#edit-segments)
* [Создать CSV файл с историей добавления/выбывания сегментов](#create-csv)
* [Скачать CSV файл с историей добавления/выбывания сегментов](#download-csv)
